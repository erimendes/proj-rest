...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Usuário registrado com sucesso', type: auth_response_dto_1.AuthResponseDto }),
    (0, swagger_1.ApiConflictResponse)({ description: 'E-mail já existe' }),
    (0, swagger_1.ApiBadRequestResponse)({ description: 'Dados inválidos' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
